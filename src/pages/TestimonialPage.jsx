      ...
      <div className="testimonial">
        <Container>
          <Row>
            ...
            <p className="text-center animate__animated animate__fadeInUp animate__delay-1s">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias, fugiat.</p>
            </Col>
          </Row>
